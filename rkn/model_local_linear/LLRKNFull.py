from transition_cell.LLRKNTransitionCellFull import LLRKNTransitionCellFull
...
class LLRKNFull(RKN):
    ...
    def _build_transition_cell(self):
        ...
        with tf.name_scope("TransitionModel"):
            ...
            self.transition_cell = LLRKNTransitionCellFull(config=self.c,
                                                           basis_matrices=self.transition_matrix_basis,
                                                           coefficenet_fn=lambda x: transition_net(x, self.training),
